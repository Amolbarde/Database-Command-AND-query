...
--amol1=# 
create table orders1 (id int, status varchar(20) DEFAULT 'PENDING');
CREATE TABLE
...
CREATE TABLE cart (product_id INT, quantity INT DEFAULT 1);
CREATE TABLE
...
create table logs ( id INT, created_date DATE DEFAULT CURRENT_DATE);
CREATE TABLE
